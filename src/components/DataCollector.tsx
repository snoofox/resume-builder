...
export const DataCollector = () => {
    ...
    const handleChangeProject = (e) => {
        ...
        const tempProjectData: any = projectData;
    ...
    const handleChangeEducation = (e) => {
        ...
        const tempEducationData: any = educationData;
    ...
    const handleEducationClick = (e) => {
        ...
        const arr: any = educationArrTemplate;
        arr.push(template);
        ...
        <>
            <div id="form-collect">
                ...
                <div id="form-personal" className="mb-2">
                    ...
                    {workCount > 0
                        ? workArrTemplate.map((element, index) => <div key={index}>{element}</div>)
                        : null}
                </div>
