...
import { themeData } from "../db/themeData";
import homeLogo from "../assets/home-logo.png";
import "../styles/intro.css";

export const Intro = () => {
    const { selectBtn, setSelectBtn, setCurrentTheme, showComponent, setShowComponent } =
                    ...
                    <>
                        <Box maxW={{ base: "100%", md: "61%" }} className="templatesList">
                            {themeData.map((item, index) => {
                                return (
                                    <Box key={index} className="template" onClick={showTheme}>
                                        <Image
                                            id={item.id}
                                            src={item.imageSrc}
                                            alt={item.imageAlt}
